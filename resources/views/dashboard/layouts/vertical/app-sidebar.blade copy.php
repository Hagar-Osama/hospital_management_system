   ...
   <aside class="app-sidebar sidebar-scroll">
       ...
       <div class="main-sidemenu">
           ...
           <ul class="side-menu">
               ...
               <li class="slide">
                   <a class="side-menu__item" href="{{ url('icons') }}"><svg xmlns="http://www.w3.org/2000/svg"
                       ...
                       </svg><span class="side-menu__label">Icons</span><span class="badge bg-danger text-light"
