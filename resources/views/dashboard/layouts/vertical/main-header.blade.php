               ...
               <div class="responsive-logo">
                   <a
                       href="{{ auth()->guard('admin')->check()
                           ? route('admin.index')
                           : route('user.index') }}"><img
                           src="{{ asset('backend/assets/img/brand/logo.png') }}" class="logo-1" alt="logo"></a>
                   <a
                       href="{{ auth()->guard('admin')->check()
                           ? route('admin.index')
                           : route('user.index') }}"><img
                           src="{{ asset('backend/assets/img/brand/logo-white.png') }}" class="dark-logo-1"
                           alt="logo"></a>
                   <a
                       href="{{ auth()->guard('admin')->check()
                           ? route('admin.index')
                           : route('user.index') }}"><img
                           src="{{ asset('backend/assets/img/brand/favicon.png') }}" class="logo-2" alt="logo"></a>
                   <a
                       href="{{ auth()->guard('admin')->check()
                           ? route('admin.index')
                           : route('user.index') }}"><img
                           src="{{ asset('backend/assets/img/brand/favicon-white.png') }}" class="dark-logo-2"
                           alt="logo"></a>
               </div>
                           ...
                           <a href="#" class="d-flex  nav-item country-flag1" data-bs-toggle="dropdown"
                               ...
                               @if (App::getLocale() == 'ar')
                                   <span class="avatar country-Flag me-0 align-self-center bg-transparent">
                                       <img src="{{ asset('backend/assets/img/flags/egypt_flag.jpg') }}"
                                           alt="img"></span>
                                   <div class="my-auto">
                                       <strong class="me-2 ms-2 my-auto">
                                           {{ LaravelLocalization::getCurrentLocaleNative() }}
                                       </strong>
                                   </div>
                               @else
                                   <span class="avatar country-Flag me-0 align-self-center bg-transparent">
                                       <img src="{{ asset('backend/assets/img/flags/us_flag.jpg') }}"
                                           alt="img"></span>
                                   <div class="my-auto">
                                       <strong class="me-2 ms-2 my-auto">
                                           {{ LaravelLocalization::getCurrentLocaleNative() }}
                   ...
                   <li class="dropdown main-profile-menu nav nav-item nav-link">
                       ...
                       <div class="dropdown-menu">
                           ...
                           <a class="dropdown-item" href="{{ url('mail-settings') }}"><i
                                   class="bx bx-slider-alt"></i> Account
                               Settings</a>
                           ...
                           @endif
                           @csrf
                           <button class="dropdown-item"><i class="bx bx-log-out"></i> Sign
                               Out</button>
                           </form>
                       </div>
                   </li>
