...
<html lang="en">
	<head>
        ...
        @include('dashboard.dashboard.layouts.horizontal.styles')
    ...
    <body class="main-body app sidebar-mini">
        ...
        <!-- main-header -->
        @include('dashboard.layouts.horizontal.main-header')
        <!-- main-header -->

        <!-- main-header -->
        @include('dashboard.layouts.horizontal.centerlogo-header')
        <!--/main-header -->
