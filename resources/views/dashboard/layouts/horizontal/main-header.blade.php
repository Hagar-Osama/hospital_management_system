       ...
       <div class="container">
           <div class="main-header-left ">
               ...
               <a class="header-brand"
                   ...
                   <img src="{{ asset('backend/assets/img/brand/logo-white.png') }}" class="desktop-dark">
                   <img src="{{ asset('backend/assets/img/brand/logo.png') }}" class="desktop-logo">
                   <img src="{{ asset('backend/assets/img/brand/favicon.png') }}" class="desktop-logo-1">
                   <img src="{{ asset('backend/assets/img/brand/favicon-white.png') }}" class="desktop-logo-dark">
               </a>
               ...
               <ul class="nav nav-item  navbar-nav-right ms-auto">
                       ...
                       <div class="dropdown  nav-itemd-none d-md-flex">
                           <a href="#" class="d-flex  nav-item country-flag1" data-bs-toggle="dropdown"
                               ...
                               <span class="avatar country-Flag me-0 align-self-center bg-transparent"><img
                                       src="{{ asset('backend/assets/img/flags/us_flag.jpg') }}" alt="img"></span>
                               <div class="my-auto">
                           ...
                           <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                               <a href="#" class="dropdown-item d-flex ">
                                   <span class="avatar  me-3 align-self-center bg-transparent"><img
                                           src="{{ asset('backend/assets/img/flags/french_flag.jpg') }}"
                                           alt="img"></span>
                                   <div class="d-flex">
                               ...
                               <a href="#" class="dropdown-item d-flex">
                                   <span class="avatar  me-3 align-self-center bg-transparent"><img
                                           src="{{ asset('backend/assets/img/flags/germany_flag.jpg') }}"
                                           alt="img"></span>
                                   <div class="d-flex">
                               ...
                               <a href="#" class="dropdown-item d-flex">
                                   <span class="avatar me-3 align-self-center bg-transparent"><img
                                           src="{{ asset('backend/assets/img/flags/italy_flag.jpg') }}"
                                           alt="img"></span>
                                   <div class="d-flex">
                               ...
                               <a href="#" class="dropdown-item d-flex">
                                   <span class="avatar me-3 align-self-center bg-transparent"><img
                                           src="{{ asset('backend/assets/img/flags/russia_flag.jpg') }}"
                                           alt="img"></span>
                                   <div class="d-flex">
                               ...
                               <a href="#" class="dropdown-item d-flex">
                                   <span class="avatar  me-3 align-self-center bg-transparent"><img
                                           src="{{ asset('backend/assets/img/flags/spain_flag.jpg') }}"
                                           alt="img"></span>
                                   <div class="d-flex">
                           ...
                           <div class="main-message-list chat-scroll">
                               <a href="#" class="p-3 d-flex border-bottom">
                                   <div class="  drop-img  cover-image  "
                                       data-bs-image-src="{{ asset('backend/assets/img/faces/3.jpg') }}">
                               ...
                               <a href="#" class="p-3 d-flex border-bottom">
                                   <div class="drop-img cover-image"
                                       data-bs-image-src="{{ asset('backend/assets/img/faces/2.jpg') }}">
                                       <span class="avatar-status bg-teal"></span>
                                   </div>
                                   <div class="wd-90p">
                                       <div class="d-flex">
                               ...
                               <a href="#" class="p-3 d-flex border-bottom">
                                   <div class="drop-img cover-image"
                                       data-bs-image-src="{{ asset('backend/assets/img/faces/9.jpg') }}">
                                       <span class="avatar-status bg-teal"></span>
                                   </div>
                                   <div class="wd-90p">
                                       <div class="d-flex">
                               ...
                               <a href="#" class="p-3 d-flex border-bottom">
                                   <div class="drop-img cover-image"
                                       data-bs-image-src="{{ asset('backend/assets/img/faces/12.jpg') }}">
                                       <span class="avatar-status bg-teal"></span>
                                   </div>
                                   <div class="wd-90p">
                                       <div class="d-flex">
                               ...
                               <a href="#" class="p-3 d-flex border-bottom">
                                   <div class="drop-img cover-image"
                                       data-bs-image-src="{{ asset('backend/assets/img/faces/5.jpg') }}">
                                       <span class="avatar-status bg-teal"></span>
                                   </div>
                                   <div class="wd-90p">
                                       <div class="d-flex">
                   ...
                   <li class="dropdown main-profile-menu nav nav-item nav-link">
                       <a class="profile-user d-flex" href=""><img alt=""
                               src="{{ asset('backend/assets/img/faces/6.jpg') }}"></a>
                       <div class="dropdown-menu">
                           <div class="main-header-profile bg-primary p-3">
                               <div class="d-flex wd-100p">
                                   <div class="main-img-user"><img alt=""
                                           src="{{ asset('backend/assets/img/faces/6.jpg') }}" class=""></div>
                           ...
                           <a class="dropdown-item" href="{{ url('editprofile') }}"><i class="bx bx-cog"></i> Edit
                               Profile</a>
                           <a class="dropdown-item" href="{{ url('mail') }}"><i class="bx bxs-inbox"></i>Inbox</a>
                           <a class="dropdown-item" href="{{ url('mail-compose') }}"><i
                                   class="bx bx-envelope"></i>Messages</a>
                           <a class="dropdown-item" href="{{ url('mail-settings') }}"><i
                                   class="bx bx-slider-alt"></i> Account Settings</a>
