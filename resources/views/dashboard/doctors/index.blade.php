        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    data-bs-target="#deleteDoctors" data-bs-toggle="modal"
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table text-md-nowrap" id="example1">
                                <thead>
                                    <tr>
                                        <th class="wd-5p border-bottom-0"><input type="checkbox" id="select-all"></th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($doctors as $doctor)
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="doctor-checkbox" name="selectedDoctors[]" value="{{$doctor->id}}">
                                            </td>
                                            ...
                                            <td><a class="btn ripple btn-sm btn-success"
                            ...
                            <button class="btn ripple btn-danger" type="button" onclick="confirm('are you sure')">Delete Selected</button>
                        </form>
                        @foreach ($doctors as $doctor)
...
@section('scripts')
  ...
  <script src="{{ asset('backend/assets/js/sweet-alert.js') }}"></script>
    ...
    <script>
        ...
        // Get all the doctor checkboxes
        const doctorCheckboxes = document.querySelectorAll(".doctor-checkbox");

        // Add an event listener to the "Select All" checkbox
        selectAllCheckbox.addEventListener("change", function() {
            // Iterate through all doctor checkboxes and set their checked state to match the "Select All" checkbox
