        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.services.update', ['serviceId' => $service->id]) }}" method="POST"
                        ...
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" name="name" value="{{ old('name', $service->name) }}"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg">
                                        <textarea class="form-control" name="description" placeholder="Textarea" rows="3">{{old('description', $service->description)}}</textarea>
                                        @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="price" value="{{ old('price', $service->price) }}"
