                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="btn ripple btn-primary" style="float: right"
                            href="{{ route('admin.services.create') }}">Add
                            A Service</a>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="wd-10p border-bottom-0">Service name</th>
                                    <th class="wd-10p border-bottom-0">Service Description</th>
                                    <th class="wd-10p border-bottom-0">Service Price</th>
                                    <th class="wd-10p border-bottom-0">Service Status</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($services as $service)
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="delete-selected" value="{{ $service->id }}"
                                                class="delete_select">
                                        </td>
                                        ...
                                        <td>
                                            @if ($service->status == App\Http\Enums\ServiceStatusEnum::ACTIVE)
                                                <a href=""<button class="badge rounded-pill bg-success">Active</button>
                                            @else
                                                <a href=""<button class="badge rounded-pill bg-danger">InActive</button>

                                            @endif
                                        </td>
                                        <td>
                                            <a class="btn ripple btn-sm btn-success"
                                                href="{{ route('admin.services.edit', ['serviceId' => $service->id]) }}">Edit</a>
                                            <a class="btn ripple btn-sm btn-danger"
                                                data-bs-target="#deleteService{{ $service->id }}" data-bs-toggle="modal"
                                                href="">Delete</a>
                                        </td>
